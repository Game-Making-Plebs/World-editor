baubleUtils = {
    ...
    newBauble: ({left, top}) => {
        ...
        baubleE.id = editorAttributes.elementCounter;
        baubleE.className = "bauble";
        canvas.append(baubleE);
        instance.draggable(baubleE);
        ...
        instance.makeSource(baubleE, {
            filter: ".bauble",
            anchor: "Continuous",
            connectionType: "regularArrow"
        })
        instance.makeTarget(baubleE, {
        ...
        editorAttributes.elementCounter++;
    },
    ...
    drawConnection: event => {
        ...
        let endpoint = instance.addEndpoint(hoverSelection, editorAttributes.sourceEndpointOptions);
    },
